...
namespace Gnome.NoCaptcha
{
   public class NoCaptcha
   {
      ...
      public string SecureToken => EncryptToken(GetToken());
      ...
      {
         HttpWebRequest wreq = (HttpWebRequest)WebRequest.Create($"https://www.google.com/recaptcha/api/siteverify?secret={SecretKey}&response={response}&remoteip={ip}");
